  ...
  .popup__wrapper
    .popup__content.Application-content
      ...
      .popup__body.Application__body.Application-body
        h5.Application-body__title Заявка
        ...
        form.Application-form
          ...
          .Application-form__coll.radio
            ...
            label(for="GSM") GSM шлюз

          .Application-form__coll.radio
            input(type="radio" id="noEquipment" value="noEquipment" v-model="equipment")
            label(for="noEquipment") У меня нет оборудования

          .Application-form__coll.radio
            input(type="radio" id="API" value="API"  v-model="equipment")
            label(for="API") Предоставление номеров по API

          .Application-form__coll
            input.input(placeholder='Количество портов Вашего оборудования' type="number" v-model="quantityPorts")
