...
export function formQuantity() {
	function countFunc(count) {
		let btnPlus = count.querySelector('.quantity__button_plus');
		let btnMinus = count.querySelector('.quantity__button_minus');
		let field = count.querySelector('.quantity__input input');
